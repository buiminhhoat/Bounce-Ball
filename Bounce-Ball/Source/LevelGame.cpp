...
void showLife(LTexture lifeText, LifeObject life, SDL_Renderer* screen) {
    ...
    gbarLife->loadImage("Resources/Image/life/gbar_Life.png", screen);
...
void showRemainRings(LTexture remainRingText, Management &object, SDL_Renderer* screen) {
    ...
    gbarRing->loadImage("Resources/Image/rings/gbar_Ring.png", screen);
...
void showGameOver(SDL_Renderer* screen) {
    BaseObject gameOver;
    gameOver.loadImage("Resources/Image/gameover/gameover.png", screen);
...
void displaySettings(InfoPlayer *infoPlayer, SDL_Renderer* screen) {
    ...
    boardSettings.loadImage("Resources/Image/settingsBoard/settingsBoard.png", screen);
    ...
    soundOnButton.loadImage("Resources/Image/settingsBoard/settingsBoard_OnButton.png", screen);
    ...
    soundOnButtonClick.loadImage("Resources/Image/settingsBoard/settingsBoard_OnButton_click.png", screen);
    ...
    soundOffButton.loadImage("Resources/Image/settingsBoard/settingsBoard_OffButton.png", screen);
    ...
    soundOffButtonClick.loadImage("Resources/Image/settingsBoard/settingsBoard_OffButton_click.png", screen);
    ...
    saveButton.loadImage("Resources/Image/settingsBoard/settingsBoard_SaveButton.png", screen);
    ...
    saveButtonClick.loadImage("Resources/Image/settingsBoard/settingsBoard_SaveButton_click.png", screen);
    ...
    restoreButton.loadImage("Resources/Image/settingsBoard/settingsBoard_RestoreButton.png", screen);
    ...
    restoreButtonClick.loadImage("Resources/Image/settingsBoard/settingsBoard_RestoreButton_click.png", screen);
    ...
    backButton.loadImage("Resources/Image/settingsBoard/settingsBoard_BackButton.png", screen);
    ...
    backButtonClick.loadImage("Resources/Image/settingsBoard/settingsBoard_BackButton_click.png", screen);
    ...
    exitButton.loadImage("Resources/Image/settingsBoard/settingsBoard_exitButton.png", screen);
    ...
    exitButtonClick.loadImage("Resources/Image/settingsBoard/settingsBoard_exitButton_click.png", screen);
...
int LevelGame::loadLevelGame(const char* nameFileMap, SDL_Renderer* screen, 
    ...
    Cryptosystem tmp;
    string addressBackground = "Resources/Image/background/background";
    ...
    player.loadImage("Resources/Image/ball/ball.png", screen);
    ...
    ButtonObject backButton;
    backButton.loadImage("Resources/Image/button/back_button.png", screen);
    ...
    ButtonObject backButtonClick;
    backButtonClick.loadImage("Resources/Image/button/back_button_click.png", screen);
    backButtonClick.setXPos(0);
    backButtonClick.setYPos(SCREEN_HEIGHT - backButtonClick.getRect().h);
    backButtonClick.setRectPos(backButtonClick.getXPos(), backButtonClick.getYPos());

    ButtonObject settingsButton;
    settingsButton.loadImage("Resources/Image/button/settings_button.png", screen);
    ...
    settingsButtonClick.loadImage("Resources/Image/button/settings_button_click.png", screen);
    ...
    while (!isQuit) {
        ...
        if (object.getIsIntersectBallVsThreats()) {
            ...
            //infoPlayer->setYourHighScore(score.getYourHighScore());
            //return BounceBall::levelType::NEXT_LEVEL;
            player.loadImage("Resources/Image/ball/ball_pop.png", screen);
            player.render(screen);
